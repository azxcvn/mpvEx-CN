          ...
          item {
            PreferenceCard {
              ...
              SwitchPreference(
                ...
                title = { Text(text = stringResource(R.string.autoplay_next_video)) },
                summary = {
                  Text(
              ...
              SwitchPreference(
                ...
                title = { Text(text = stringResource(R.string.enable_next_previous_navigation)) },
                summary = {
                  Text(
                    text = if (playlistMode)
                      "显示文件夹内所有视频的上一个/下一个按钮"
                    else
                      "单独播放视频（可多选以创建播放列表）",
                    color = MaterialTheme.colorScheme.outline,
                  )
