...
fun FileSystemBrowserScreen(path: String? = null) {
  ...
  Box(modifier = Modifier.fillMaxSize()) {
    ...
    DeleteConfirmationDialog(
      ...
      itemType = when {
        folderSelectionManager.isInSelectionMode && videoSelectionManager.isInSelectionMode -> "项目"
        folderSelectionManager.isInSelectionMode -> "文件夹"
        else -> "视频"
      },
...
fun FileSystemSortDialog(
  ...
  SortDialog(
    ...
    getLabelForType = { type, _ ->
      when (type) {
        app.marlboroadvance.mpvex.preferences.FolderSortType.Title.displayName -> Pair("升序", "降序")
