      ...
      AlertDialog(
        ...
        text = {
          Column(
            ...
            Text(
              "已成功导出 ${exportStats?.totalExported} 个项目！\n\n"
            )
          }
        },
        confirmButton = {
      ...
      ProvidePreferenceLocals {
        ...
        LazyColumn(
          ...
          item {
            PreferenceCard {
              Preference(
                title = { Text(text = stringResource(R.string.export_settings)) },
                summary = { 
                  Text(
                    text = "将设置导出到 XML 文件",
              ...
              Preference(
                title = { Text(text = stringResource(R.string.import_settings)) },
                summary = { 
                  Text(
                    text = "从 XML 文件导入设置",
                    color = MaterialTheme.colorScheme.outline,
          ...
          // History Section
          item {
            PreferenceSectionHeader(title = "历史")
          }
          ...
          item {
            PreferenceCard {
              ...
              Preference(
                title = { Text(text = stringResource(R.string.clear_config_cache)) },
                summary = { 
                  Text(
              ...
              Preference(
                title = { Text(text = stringResource(R.string.clear_thumbnail_cache)) },
                summary = {
                  Text(
          ...
          // Logging Section
          item {
            PreferenceSectionHeader(title = "日志")
          }
